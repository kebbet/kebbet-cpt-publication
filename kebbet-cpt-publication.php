...
function bulk_post_updated_messages( $bulk_messages, $bulk_counts ) {
	...
	$bulk_messages[ POSTTYPE ] = array(
		...
		'updated'   => _n( '%$1s post updated.', '%$2s posts updated.', $bulk_counts['updated'], 'kebbet-cpt-publication' ),
		/* translators: %$1s: singular of posts, %$2s: pluralis of posts.  */
		'locked'    => _n( '%$1s post not updated, somebody is editing it.', '%$2s posts not updated, somebody is editing them.', $bulk_counts['locked'], 'kebbet-cpt-publication' ),
		/* translators: %$1s: singular of posts, %$2s: pluralis of posts.  */
		'deleted'   => _n( '%$1s post permanently deleted.', '%$2s posts permanently deleted.', $bulk_counts['deleted'], 'kebbet-cpt-publication' ),
		/* translators: %$1s: singular of posts, %$2s: pluralis of posts.  */
		'trashed'   => _n( '%$1s post moved to the Trash.', '%$2s posts moved to the Trash.', $bulk_counts['trashed'], 'kebbet-cpt-publication' ),
		/* translators: %$1s: singular of posts, %$2s: pluralis of posts.  */
		'untrashed' => _n( '%$1s post restored from the Trash.', '%$2s posts restored from the Trash.', $bulk_counts['untrashed'], 'kebbet-cpt-publication' ),
	);
